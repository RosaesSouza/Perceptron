...
plt.tight_layout()
plt.savefig('images/blobs_results.png', dpi=300, bbox_inches='tight')
plt.show()
...
plot_decision_regions(X_train_std, y_train, classifier=ppn)
plt.title('Regiões de Decisão - Blobs')
plt.xlabel('Feature 1 (normalizada)')
plt.ylabel('Feature 2 (normalizada)')
plt.legend(loc='upper left')
plt.savefig('images/blobs_decision_regions.png', dpi=300, bbox_inches='tight')
plt.show()

# Gráfico 2: Convergência
plt.figure(figsize=(8, 6))
plt.plot(range(1, len(ppn.errors_history) + 1), ppn.errors_history, marker='o', color='red', linewidth=2)
plt.xlabel('Épocas')
plt.ylabel('Número de erros')
plt.title('Convergência do Treinamento - Blobs')
plt.grid(True, alpha=0.3)
plt.savefig('images/blobs_convergence.png', dpi=300, bbox_inches='tight')
plt.show()

print("\nGráficos salvos na pasta 'images/':")
print("- blobs_results.png (gráfico combinado)")
print("- blobs_decision_regions.png")
print("- blobs_convergence.png")